...
# color setup for ls:
check_com -c dircolors && eval $(dircolors ~/.dircolors)
...
alias las='ls -cltash'
alias :q='exit;exit'		# vim influence
alias :Q='exit;exit'
...
export MINKO_HOME=/home/natan/minko

if [ "$TMUX" = "" ]; then TERM=xterm-256color tmux -2; fi
